...
def add_table_stats(type_parser):
    '''
    This function adds the stats table subparser to the registry parser.
    ...
    func_parser = type_parser.add_parser(
        'table_stats',
        help='Create a LaTeX table of the stats results.'
    )

    # Set the function to use in the stage class
    func_parser.set_defaults(type_func=Analysis.table_stats)
...
def add_table_crypto(type_parser):
    ...
    func_parser = type_parser.add_parser(
        'table_crypto',
        help='Create a LaTeX table of the crypto results.'
    )

    # Set the function to use in the stage class
    func_parser.set_defaults(type_func=Analysis.table_crypto)
